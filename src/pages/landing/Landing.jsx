    ...
    <section className="landing">
      ...
      <main className="landing__main">
        <section className="landing__hero">
          ...
          {/* `menu` is not the right semantic element here for CTA navigation.
            Use a `div`/`section` or an actual list (`ul`) unless you
            specifically need menu semantics. */}
          ...
          <ul className="landing__pills" id="features" aria-label="Features">
            ...
            <li className="landing__pillItem landing__pillAlert">
              Overspend alert
            </li>
        ...
        <section
          className="landing__layout"
          id="preview"
          aria-label="Why Smart Expense"
        >
          <figure className="landing__phone">
            ...
            <section className="landing__phoneBody" aria-label="How it helps">
              ...
              <ul className="landing__flowLine" aria-label="User flow">
                ...
                <li className="landing__flowArrow" aria-hidden="true">
                  →
                </li>
                <li className="landing__flowStep">
                  <span className="landing__flowIcon">💳</span>
          ...
          <section className="landing__side" aria-label="Call to action">
            ...
            <ol className="landing__steps" aria-label="Highlights">
              <li className="landing__step">
                ...
                <span className="landing__stepText">
                  One goal drives every decision
                </span>
              </li>
              <li className="landing__step">
                <span className="landing__stepNum">✓</span>
                <span className="landing__stepText">
                  Instant remaining per category
                </span>
              </li>
              <li className="landing__step">
                <span className="landing__stepNum">✓</span>
                <span className="landing__stepText">
                  Overspending is impossible to miss
                </span>
              </li>
            </ol>
